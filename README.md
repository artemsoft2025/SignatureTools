...
sighunter.exe c:\
```
будут просканированы файлы с расширениями ".exe", ".dll", ".sys", ".com", ".scr", ".ocx", ".cpl", ".drv", ".efi" на всем диске C:\ размером не более 500 мб, база сигнатур берется из файла `custom_signatures.sigs`.
